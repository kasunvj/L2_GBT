...
function createRPCError(type, message, details) {
    ...
    const E = (typeof rpcErrorLUT[type] !== 'undefined' && rpcErrorLUT[type] !== null) ? rpcErrorLUT[type] : errors.RPCGenericError;
    const err = new E((typeof message !== 'undefined' && message !== null) ? message : '');
    err.details = (typeof details !== 'undefined' && details !== null) ? details : {};

    return err;
}

function checkRpcError(key) {
    return key in rpcErrorLUT;
}
