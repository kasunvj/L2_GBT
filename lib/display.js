...
const netDMGRight = {
	...
	unameLast: "Madux     ",
	ubal: 3000.08 * 100,
	// cProfile 1 : Charging to 80% 
	//          2 : Charging to 90% 
	//          3 : Charging For 15 mins 
	//          4 : Charging For 30 mins 
	cProfile: 4,
	stateFC: 'IDLE',
	errorFC: "",
}
			...
			case 'L':
				switch (stateNo) {
					case 0://Last charge
						...
						else if (liveDMGRight.page == 11) { page = 41; }// dec 41 hex 29 tap | unplug 
						else { page = 0; }
						liveDMGLeft.page = 0;
						liveDMGLeft.icon = 0;
						break;
					...
					case 1://verify
						...
						else if (liveDMGRight.page == 11) { page = 42; }// dec 42 hex 2a wait | unplg 
						else { page = 0; }
						liveDMGLeft.page = 1;
						liveDMGLeft.icon = 0;
						break;
					...
					case 2://select port
						...
						else if (liveDMGRight.page == 11) { page = 43; }// dec 43 hex 2b port | unplg
						else { page = 0; }
						liveDMGLeft.page = 2;
						liveDMGLeft.icon = 0;
						break;
					...
					case 3://plug ev
						...
						else if (liveDMGRight.page == 11) { page = 44; }// dec 44 hex 2c plug | unplg 
						else { page = 0; }
						liveDMGLeft.page = 3;
						liveDMGLeft.icon = 0;
						break;
					...
					case 4://charging
						...
						else if (liveDMGRight.page == 11) { page = 45; }// dec 45 hex 2d chng | unplg
						else { page = 0; }
						liveDMGLeft.page = 4;
						liveDMGLeft.icon = 0;
						break;
					...
					case 5://full charge //<<
						...
						else if (liveDMGRight.page == 11) { page = 46; }// dec 46 hex 2e chrgd | unplg 
						else { page = 0; }
						liveDMGLeft.page = 5;
						liveDMGLeft.icon = 0;
						break;
					...
					case 6:// empty page, to display, go to please wait and [present right page]
						...
						else if (liveDMGRight.page == 11) { page = 48; } // wait | unplug
						else { page = 7; }
						liveDMGLeft.page = 1;
						break;
					...
					case 7:// empty page to display insufficient bal
						...
						else if (liveDMGRight.page == 11) { page = 48; }
					...
					case 11:// unplug ev
						if (liveDMGRight.page == 0) { page = 48; }      //(48) dec 48 hex 30 unplg| tap 
						else if (liveDMGRight.page == 1) { page = 49; } //(49) dec 49 hex 31 unplg| wait
						else if (liveDMGRight.page == 2) { page = 50; } //(50) dec 50 hex 32 unplg| port
						else if (liveDMGRight.page == 3) { page = 18; } //     dec 18 hex 12 wait | user 
						else if (liveDMGRight.page == 4) { page = 51; } //(51) dec 51 hex 33 unplg| plug
						else if (liveDMGRight.page == 5) { page = 52; } //(52) dec 52 hex 34 unplg| charg
						else if (liveDMGRight.page == 6) { page = 53; } //(53) dec 53 hex 35 unplg| chrgd
						else if (liveDMGRight.page == 11) { page = 47; }//(54) dec 53 hex 2f unplg| unplg 
						else { page = 7; } // wait | wait
						liveDMGLeft.page = 11;
						liveDMGLeft.icon = 0;
						break;
			...
			case 'R':
				switch (stateNo) {
					case 0:// last charge
						...
						else if (liveDMGLeft.page == 11) { page = 48; }  // dec 48 hex 30 unplg | tap 
						else { page = 0; }
						liveDMGRight.page = 0;
						liveDMGRight.icon = 0;
						break;
					...
					case 1:// please wait
						...
						else if (liveDMGLeft.page == 11) { page = 49; } // dec 49 hex 31 unplg | wait 
						else { page = 0; }
						liveDMGRight.page = 1;
						liveDMGRight.icon = 0;
						break;
					...
					case 2: // connect port
						...
						else if (liveDMGLeft.page == 11) { page = 50; } // dec 50 hex 32 unplg | port 
						else { page = 0; }
						liveDMGRight.page = 2;
						liveDMGRight.icon = 0;
						break;
					...
					case 3: // select charging mode
						...
						else if (liveDMGLeft.page == 11) { page = 18; } 
						else { page = 0; }
						liveDMGRight.page = 3;
						liveDMGRight.icon = 0;
						break;
					...
					case 4: // plug ev
						...
						else if (liveDMGLeft.page == 11) { page = 51; }// dec 51 hex 33 unplg | port 
						else { page = 0; }
						liveDMGRight.page = 4;
						liveDMGRight.icon = 0;
						break;
					...
					case 5: // charging
						...
						else if (liveDMGLeft.page == 11) { page = 52; }// dec 52 hex 34 unplg | port 
						else { page = 0; }
						liveDMGRight.page = 5;
						liveDMGRight.icon = 0;
						break;
					...
					case 6: // charged
						...
						else if (liveDMGLeft.page == 11) { page = 53; }// dec 53 hex 35 unplg | port 
						else { page = 0; }
						liveDMGRight.page = 6;
						liveDMGRight.icon = 0;
						break;
					...
					case 11:// unplug ev
						if (liveDMGLeft.page == 0) { page = 41; }      // dec 41 hex 29 tap  | unplg
						else if (liveDMGLeft.page == 1) { page = 42; } // dec 42 hex 2a wait | unplg 
						else if (liveDMGLeft.page == 2) { page = 43; } // dec 43 hex 2b port | unplg
						else if (liveDMGLeft.page == 3) { page = 44; } // dec 44 hex 2c plug | unplg 
						else if (liveDMGLeft.page == 4) { page = 45; } // dec 45 hex 2d chng | unplg
						else if (liveDMGLeft.page == 5) { page = 46; } // dec 46 hex 2e chrgd| unplg 
						else if (liveDMGLeft.page == 11) { page = 47; }// dec 47 hex 2f unplg| unplg 
						else { page = 7; } // wait | wait
						liveDMGRight.page = 11;
						liveDMGRight.icon = 0;
						break;
			...
			case 'L':
				switch (page) {
					case 0://last charge[chargerID,LastCharge%,time,Cost,kwhRate]
						...
						/* Charger ID Char*/
						cidLetter = Buffer.from((netDMGLeft.cidChar).toString('hex'))
						dmgDataBuf = Buffer.concat([Buffer.from([0x14, 0x30]),cidLetter], 4); // 0x4C-L
						objDMG.dmgCIDChangeMsg(dmgDataBuf);
					...
					case 4://charging
						...
						console.log("L Hours: ",liveTimeHNow)
						dmgDataBuf = Buffer.concat([Buffer.from([0x13, 0x35]), liveTimeHNow], 4);
						objDMG.dmgDataChangeMsg(dmgDataBuf);
						
						/*live time M*/
						liveTimeMNow = Buffer.from((liveDMGLeft.liveTimeM).toString(16).padStart(4, '0'), 'hex');
						console.log("L MIns: ",liveTimeMNow)
			...
			case 'R':
				switch (page) {
					case 0://IDELING  PAGE[chargerID,LastCharge%,time,Cost,kwhRate]
						...
						/* Charger ID Char*/
						cidLetter = Buffer.from((netDMGRight.cidChar).toString('hex'))
						dmgDataBuf = Buffer.concat([Buffer.from([0x14, 0x40]),cidLetter], 4); // 0x52-R
						objDMG.dmgCIDChangeMsg(dmgDataBuf);
					...
					case 5://CHARGING  
						...
						/*Energy kWh*/
						kwhLive = Buffer.from((liveDMGRight.kwhLive*10).toString(16).padStart(4, '0'), 'hex');
						...
						/*live time M */
						liveTimeMNow = Buffer.from((liveDMGRight.liveTimeM).toString(16).padStart(4, '0'), 'hex');
						...
						if (netDMGRight.cProfile == 1) {
							...
							objDMG.dmgIcon(Buffer.from([0x84, 0x00, 0x90]));
						}
						else if (netDMGRight.cProfile == 3) {
							objDMG.dmgIcon(Buffer.from([0x84, 0x00, 0x92]));
						}
						else if (netDMGRight.cProfile == 4) {
							
							objDMG.dmgIcon(Buffer.from([0x84, 0x00, 0x94]));
						}
						else {
